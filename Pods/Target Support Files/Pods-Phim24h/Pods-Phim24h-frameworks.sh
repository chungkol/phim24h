...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "$BUILT_PRODUCTS_DIR/HTPullToRefresh/HTPullToRefresh.framework"
  ...
  install_framework "$BUILT_PRODUCTS_DIR/OEANotification/OEANotification.framework"
fi
