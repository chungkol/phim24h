...
class Bar: UIView {
    ...
    fileprivate var elementFindCache = [String: UIView]()
    ...
    func addElementUsingConfig(_ config: ElementConfig) {
    ...
    func getViewForElementWithIdentifier(_ identifier: String) -> UIView? {
