...
class YoutubeParser: NSObject {
    ...
    fileprivate static func decodeURLEncodedString(_ urlString: String) -> String {
        let withSpaces = urlString.replacingOccurrences(of: "+", with:" ")
        return withSpaces.removingPercentEncoding ?? withSpaces
    }
    
    fileprivate static func queryStringToDictionary(_ queryString: String) -> [String: AnyObject] {
